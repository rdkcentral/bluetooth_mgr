...
BTRMgr_SI_GstInit (
    ...
    MEMSET_S((void*)pstBtrMgrSiGst, sizeof(stBTRMgrSIGst), 0, sizeof(stBTRMgrSIGst));
...
BTRMgr_SI_GstSetVolume (
    ...
    BTRMGRLOG_INFO("Volume at StreamIn Gst = %d, %f\n", ui8Volume, ui8Volume/100.0);
...
BTRMgr_SI_GstSendBuffer (
    ...
    /* push Buffers */
    {
        ...
        MEMCPY_S(gstBufMap.data, aiInBufSize, pcInBuf, aiInBufSize);
