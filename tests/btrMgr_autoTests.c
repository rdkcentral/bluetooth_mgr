...
BTRMGR_TEST_STATUS testConnectAudioDevice()
{
    ...
    EXPECT_BTRMGRRET_RESPONSE(BTRMGR_ConnectToDevice(0, getDeviceIDFromMac(deviceToConnect.address), BTRMGR_DEVICE_OP_TYPE_AUDIO_OUTPUT), BTRMGR_RESULT_SUCCESS);
    EXPECT_TRUE(EXPECT_AND_WAIT_BLUEZ_EVENT("Connect", NULL, LONG_WAIT));
