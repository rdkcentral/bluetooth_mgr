...
#define BTRMGR_SO_MAX_DELAY    500
...
/**
 * @brief This API will set the current delay used by this interface.
 *
 * @param[in]  hBTRMgrSoHdl             Handle to the bluetooth manager stream out interface.
 * @param[in]  ui16Delay                Delay of media device that has to be set.
 *
 * @return Returns the status of the operation.
 * @retval eBTRMgrSuccess on success, appropriate  error code otherwise.
 */
eBTRMgrRet BTRMgr_SO_SetDelay (tBTRMgrSoHdl hBTRMgrSoHdl, unsigned int ui16Delay);
/**
 * @brief This API will fetches the current delay used by this interface.
 *
 * @param[in]  hBTRMgrSoHdl             Handle to the bluetooth manager stream out interface.
 * @param[in]  ui16Delay                Delay of media device that has to be fetched.
 *
 * @return Returns the status of the operation.
 * @retval eBTRMgrSuccess on success, appropriate  error code otherwise.
 */
eBTRMgrRet BTRMgr_SO_GetDelay (tBTRMgrSoHdl hBTRMgrSoHdl, unsigned int* ui16Delay, unsigned int* ui16MsInQueue);
/**
 * @brief This API will calculate and set the delay on the stream out interface based on the delay given by the media device
 *
 * @param[in]  hBTRMgrSoHdl             Handle to the bluetooth manager stream out interface.
 * @param[in]  ui16DeviceDelay          Delay of media device that informs the delay that will be set on the stream out interface.
 *
 * @return Returns the status of the operation.
 * @retval eBTRMgrSuccess on success, appropriate  error code otherwise.
 */
eBTRMgrRet BTRMgr_SO_UpdateDelayDynamically (tBTRMgrSoHdl hBTRMgrSoHdl, unsigned int ui16DeviceDelay);
/**
