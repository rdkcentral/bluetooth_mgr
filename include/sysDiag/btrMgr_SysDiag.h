...
typedef enum _BTRMGR_SysDiagChar_t {
    ...
    BTRMGR_SYS_DIAG_QR_CODE,
    BTRMGR_SYS_DIAG_PROVISION_STATUS,
    BTRMGR_SYS_DIAG_SIM_ICCID,
    BTRMGR_SYS_DIAG_MODEM_IMEI,
    BTRMGR_SYS_DIAG_CELLULAR_SIGNAL_STRENGTH,
    BTRMGR_SYS_DIAG_MESH_BACKHAUL_TYPE,
    BTRMGR_SYS_DIAG_WIFI_BACKHAUL_STATS,
    BTRMGR_SYS_DIAG_BLE_BROADCAST_STATUS,
...
eBTRMgrRet BTRMGR_SD_GetData(tBTRMgrSDHdl hBTRMgrSdHdl, BTRMGR_SysDiagChar_t aenSysDiagChar, char* aData);

eBTRMgrRet BTRMGR_SD_SetData(tBTRMgrSDHdl hBTRMgrSdHdl, BTRMGR_SysDiagChar_t aenSysDiagChar, unsigned char* aData);

eBTRMgrRet BTRMGR_SD_ConnectToWifi(tBTRMgrSDHdl hBTRMgrSdHdl, char* aSSID, char* aPassword, int aSecurityMode);

eBTRMgrRet BTRMGR_SD_Check_Cellularmanager_ISOnline(char *lte_wan_status, bool *lte_enable);
/** @} */
